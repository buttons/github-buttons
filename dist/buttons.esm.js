 ...
 */
var window$1 = globalThis.window;

var document = window$1.document;

var Math$1 = window$1.Math;

var HTMLElement = window$1.HTMLElement;

var XMLHttpRequest = window$1.XMLHttpRequest;
...
var render$1 = function (root, options, func) {
  ...
  var tooltip;
  var hasTooltip = options['data-tooltip'] != null && options['data-tooltip'] !== '';
  if (hasTooltip) {
    var tooltipPosition = toLowerCase(options['data-tooltip-position']) || 'top';
    ...
    var calculatePosition = function () {
      ...
      if (tooltipPosition === 'top' || tooltipPosition === 'bottom') {
        ...
        var spaceBottom = viewportHeight - btnRect.bottom;
        ...
        var spaceRight = viewportWidth - btnRect.right;
