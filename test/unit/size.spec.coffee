...
describe "Size", ->
  ...
  describe "get(el)", ->
    ...
    it "should return size without Element::getBoundingClientRect()", ->
    ...
    it "should return size with Element::getBoundingClientRect()", ->
    ...
    it "should return size with Element::getBoundingClientRect() that lacks of width and height properties", ->
      el.getBoundingClientRect = sinon.stub().returns
        top: 0
        right: size[0]
        bottom: size[1]
