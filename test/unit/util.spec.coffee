...
describe "Util", ->
  ...
  describe "createElementInDocument(document)", ->
    it "should return a createElement function for given document", ->
      iframe = document.body.appendChild document.createElement "iframe"
      element = createElementInDocument(iframe.contentWindow.document) "div"
