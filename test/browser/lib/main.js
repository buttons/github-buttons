  ...
  describe('ButtonAnchor', function() {
    ...
    return describe('.parse()', function() {
      ...
      it('should parse the attribute data-count-api', function() {
        ...
        return expect(ButtonAnchor.parse(a)).to.have.property("data-count-api").and.equal(api);
      });
      it('should parse the attribute data-count-href', function() {
        var href;
        href = "https://github.com/";
        a.setAttribute("data-count-href", href);
        return expect(ButtonAnchor.parse(a)).to.have.property("data-count-href").and.equal(href);
      });
  ...
  describe('ButtonFrameContent', function() {
    ...
    return describe('#constructor()', function() {
      ...
      it('should append the count to document.body when the necessary options are given', function() {
        ...
        return expect(count).to.have.property("className").and.equal("count");
      });
      it('should append the count with given data-count-href', function() {
        ...
        count = document.body.appendChild.args[1][0];
        head.appendChild.restore();
        return expect(count.getAttribute("href")).to.equal(options["data-count-href"]);
      });
      it('should append the count with #entry from api response', function() {
        ...
        count = document.body.appendChild.args[1][0];
        head.appendChild.restore();
        return expect(count.lastChild.innerHTML).to.equal("26");
      });
      ...
      it('should append the count with large number split by comma', function() {
        ...
        options = {
          "data-count-api": "/dummy/api#id"
        };
        new ButtonFrameContent(options);
        count = document.body.appendChild.args[1][0];
        head.appendChild.restore();
        return expect(count.lastChild.innerHTML).to.equal("899,645");
      });
      ...
      it('should append the count with text undefined when missing # in api', function() {
        ...
        options = {
          "data-count-api": "/dummy/api"
        };
        new ButtonFrameContent(options);
        count = document.body.appendChild.args[1][0];
        head.appendChild.restore();
        return expect(count.lastChild.innerHTML).to.equal("undefined");
      });
