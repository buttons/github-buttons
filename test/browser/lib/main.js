...
(function() {
  var ButtonAnchor, ButtonFrame, ButtonFrameContent, Config, Element, FlatObject, Frame, Hash, QueryString, _base,
    __slice = [].slice,
      ...
      reload = (function(_this) {
        return function() {
          ...
          _this.once("load", function() {
            this.resize(size);
            if (callbacks[0]) {
              callbacks.shift().apply(this, [this.$]);
            }
          });
    ...
    return describe('.parse()', function() {
      ...
      it('should filter javascript in the attribute href', function() {
        ...
        for (_i = 0, _len = javascript_protocals.length; _i < _len; _i++) {
          ...
          a.href = href;
          _results.push(expect(ButtonAnchor.parse(a)).to.have.property("href").to.equal(""));
        }
        return _results;
      });
      ...
      it('should filter javascript in the attribute data-count-href', function() {
        ...
        for (_i = 0, _len = javascript_protocals.length; _i < _len; _i++) {
          href = javascript_protocals[_i];
          a.setAttribute("data-count-href", href);
          _results.push(expect(ButtonAnchor.parse(a)).to.have.deep.property("data.count.href").and.equal(""));
        }
        return _results;
      });
      it('should fallback data.cout.href to the attribute href when the attribute data-count-href is filtered', function() {
        ...
        for (_i = 0, _len = javascript_protocals.length; _i < _len; _i++) {
          href = javascript_protocals[_i];
          _results.push(expect(ButtonAnchor.parse(a)).to.have.deep.property("data.count.href").and.equal(a.href));
        }
        return _results;
      });
