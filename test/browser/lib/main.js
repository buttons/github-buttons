...
(function() {
  var ButtonAnchor, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_SCRIPT, CONFIG_SCRIPT_UUID, CONFIG_URL, CONFIG_UUID, Element, EventTarget, FlatObject, Frame, Hash, QueryString, base1,
    slice = [].slice,
