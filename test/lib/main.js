...
(function() {
  var BASEURL, BUTTON_CLASS, GITHUB_API_BASEURL, ICON_CLASS, ICON_CLASS_DEFAULT, Math, UUID, ceilPixel, createAnchor, createElement, createTextNode, decodeURIComponent, defer, document, encodeURIComponent, getFrameContentSize, jsonp, offEvent, onEvent, onceEvent, onceScriptLoad, parseConfig, parseQueryString, render, renderAll, renderButton, renderCount, renderFrameContent, setFrameSize, stringifyQueryString;
  ...
  describe("Event", function() {
    ...
    describe("offEvent(target, eventName, func)", function() {
      return it("should turn off the function on event", function() {
        var spy;
        spy = sinon.spy();
        onEvent(input, "click", spy);
        input.click();
