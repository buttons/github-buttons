...
(function() {
  var ButtonAnchor, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_SCRIPT, CONFIG_SCRIPT_UUID, CONFIG_URL, CONFIG_UUID, Deferred, Element, EventTarget, FlatObject, Frame, Hash, QueryString, document, window,
    slice = [].slice,
