...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_SCRIPT, CONFIG_URL, CONFIG_UUID, Code, Deferred, Element, EventTarget, FlatObject, Form, Frame, GitHubAPIStatus, Hash, PreviewAnchor, PreviewFrame, QueryString, document, window,
    slice = [].slice,
  ...
  ButtonForm = (function(superClass) {
    ...
    function ButtonForm($, arg) {
      ...
      snippet.$.value = "<!-- Place this tag anywhere on your page. -->\n<script async defer id=\"github-bjs\" src=\"https://buttons.github.io/buttons.js\"></script>";
      callback = (function(_this) {
