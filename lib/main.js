...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_URL, CONFIG_UUID, Code, Deferred, Element, EventTarget, Form, Frame, GitHubAPIStatus, Hash, NumberHelper, ObjectHelper, PreviewAnchor, PreviewFrame, QueryString, document, window,
    slice = [].slice,
