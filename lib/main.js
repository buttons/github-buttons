...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, Code, Config, Element, FlatObject, Form, Frame, GitHubAPIStatus, Hash, PreviewAnchor, PreviewFrame, QueryString, StaticFrame, document, iframe, j, len, ref, window,
    slice = [].slice,
  ...
  StaticFrame = (function(superClass) {
    ...
    function StaticFrame() {
      ...
      this.on("load", function() {
        ...
        contentDocument = this.get().contentWindow.document;
        ...
        new Element(contentDocument.body).on("click", (function(_this) {
          return function() {
