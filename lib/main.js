...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_SCRIPT, CONFIG_SCRIPT_UUID, CONFIG_URL, CONFIG_UUID, Code, Deferred, Element, EventTarget, FlatObject, Form, Frame, GitHubAPIStatus, Hash, PreviewAnchor, PreviewFrame, QueryString, document, window,
    slice = [].slice,
