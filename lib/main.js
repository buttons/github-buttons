...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, Code, Config, Element, EventTarget, FlatObject, Form, Frame, GitHubAPIStatus, Hash, PreviewAnchor, PreviewFrame, QueryString, StaticFrame, document, iframe, j, len, ref, window,
    slice = [].slice,
  ...
  StaticFrame = (function(superClass) {
    extend(StaticFrame, superClass);

    function StaticFrame() {
      var onload;
      StaticFrame.__super__.constructor.apply(this, arguments);
      onload = (function(_this) {
        return function() {
          var a, base, contentDocument, j, len, ref;
          contentDocument = _this.$.contentWindow.document;
          base = contentDocument.getElementsByTagName("base")[0];
          base.parentNode.removeChild(base);
          ref = contentDocument.getElementsByTagName("a");
          for (j = 0, len = ref.length; j < len; j++) {
            a = ref[j];
            a.href = "#";
          ...
          new Element(contentDocument.body).on("click", function() {
            _this.$.parentNode.click();
          });
        };
      })(this);
      this.on("load", function() {
        ...
        try {
          ...
          return new EventTarget(this.$.contentWindow).on("load", onload);
        }
      });
    }
  ...
  PreviewFrame = (function(superClass) {
    ...
    PreviewFrame.prototype.load = function(config) {
      this.$.parentNode.style.height = ((config.data.style === "mega" ? 28 : 20) + 2) + "px";
      this.$.style.width = "1px";
      this.$.style.height = "0";
      this.$.src = "buttons.html" + (Hash.encode(config));
      this.$.contentWindow.document.location.reload();
    };
  ...
  ButtonForm = (function(superClass) {
    ...
    function ButtonForm($, arg) {
      ...
      snippet.$.value = "<!-- Place this tag right after the last button or just before your close body tag. -->\n<script async defer id=\"github-bjs\" src=\"https://buttons.github.io/buttons.js\"></script>";
      callback = (function(_this) {
