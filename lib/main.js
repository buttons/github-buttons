...
(function() {
  var ButtonAnchor, ButtonFrame, ButtonFrameContent, Code, Config, DisabledFrame, Element, FlatObject, Form, Frame, Hash, PreviewAnchor, PreviewButton, PreviewFrame, QueryString, Snippet, UI,
    __slice = [].slice,
  ...
  DisabledFrame = (function(_super) {
    ...
    function DisabledFrame(element) {
      this.element = element;
    ...
    PreviewButton.prototype.preview = function(config, no_count) {
      ...
      new PreviewAnchor(config, (function(_this) {
        return function(a) {
          ...
          _this.ui.preview_frame.load(ButtonAnchor.parse(a));
          a = null;
        };
      })(this));
    };
  ...
  UI = (function() {
    function UI() {
      ...
      this.content = new Element(document.getElementById("content"));
      ...
      this.user_repo = new Element(document.getElementById("user-repo"));
